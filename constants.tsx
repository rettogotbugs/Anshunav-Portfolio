...
export const SKILLS: Skill[] = [
  ...
  { name: "Python", level: 92, category: 'ai-ml', icon: <Terminal /> },
  { name: "PyTorch / TensorFlow", level: 80, category: 'ai-ml', icon: <Brain /> },
  { name: "PostgreSQL", level: 85, category: 'backend', icon: <Database /> },
  { name: "Docker / AWS", level: 75, category: 'tools', icon: <Cpu /> },
];
